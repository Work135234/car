...
export default function Reports() {
  ...
  // Helper to safely get statusBreakdown
  const getStatusBreakdown = () => {
    return reportData && reportData.summary && reportData.summary.statusBreakdown ? reportData.summary.statusBreakdown : {};
  };
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{reportData?.summary?.totalBookings ? reportData.summary.totalBookings.toLocaleString() : '0'}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">${reportData?.summary?.totalRevenue ? reportData.summary.totalRevenue.toLocaleString() : '0.00'}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{typeof reportData?.summary?.completionRate === 'number' ? reportData.summary.completionRate : '0'}%</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {Array.isArray(getStatusBreakdown()) && getStatusBreakdown().map((item) => (
